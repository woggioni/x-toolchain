...
PATH=${gcc_prefix}/bin:$PATH cmake \
    ...
    -DINCLUDE_INSTALL_DIR:PATH=${gcc_prefix}/include \
    -DLIB_INSTALL_DIR:PATH=${gcc_prefix}/lib \
    -DSYSCONF_INSTALL_DIR:PATH=${gcc_prefix}/etc \
    -DSHARE_INSTALL_DIR:PATH=${gcc_prefix}/share \
    -DCMAKE_CXX_IMPLICIT_INCLUDE_DIRECTORIES:PATH=${gcc_prefix}/include \
    -DCMAKE_C_IMPLICIT_INCLUDE_DIRECTORIES:PATH=${gcc_prefix}/include \
